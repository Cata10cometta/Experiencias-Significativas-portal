												...
												<div className="px-6 py-4" key={exp.id ?? idx}>
													<div className={`grid ${showEvaluationColumn ? 'grid-cols-7' : 'grid-cols-6'} gap-4 items-center`}>
														...
														{showEvalModal && evalExpId && (
															<div className="fixed inset-0 z-50 flex items-center justify-center bg-white/[0.02] backdrop-blur-[2px]">
																<div className="bg-white rounded-xl shadow-2xl w-full max-w-3xl max-h-[90vh] overflow-auto relative">
																	<button
																		className="absolute top-4 right-4 text-gray-400 hover:text-gray-700 transition duration-150 p-1 rounded-full bg-gray-50 hover:bg-gray-100"
