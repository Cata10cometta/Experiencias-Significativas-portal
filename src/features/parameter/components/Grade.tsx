...
const GradeList: React.FC = () => {
  ...
  return (
    <div className="w-full max-w-full mx-auto mt-6 px-2 sm:px-6 py-4 sm:py-6 parameter-grades-layout">
      <Joyride
      ...
      <div className="bg-white rounded-xl border border-gray-200 shadow-sm p-2 sm:p-6">
        ...
        <div className="mb-6 flex flex-col sm:flex-row items-center gap-4 parameter-grades-toolbar">
          ...
          <div className="flex gap-4 parameter-grades-filters w-full sm:w-auto">
            <button
        ...
        <div className="overflow-x-auto overflow-y-auto bg-white rounded-2xl border border-gray-200 shadow-sm p-2 sm:p-4 max-h-[60vh] parameter-grades-table">
        ...
        <div className="mt-6 flex flex-col sm:flex-row items-center justify-between gap-2 parameter-grades-pagination">
